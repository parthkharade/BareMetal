...
// These are stored at the start of the memory barring the first 
//location which is the MSP initialisation value.
//put 0s in reserved loactions.
...
/*dont need to define all the seperate handlers over here.
 We declare all the different handler with the alias of a default_handler 
 and weak identities. Meaning that if a handler of that name is not 
 defined it will point to the deafult handler. But the programmer can ovveride this
 declaration with a function of the same name. */
{
    while (1);
